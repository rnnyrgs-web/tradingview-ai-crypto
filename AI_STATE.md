...
## SAFETY INVARIANTS
No AI opinion, ranking score, evidence score, current order-book snapshot, paper P&L, ensemble weight, single OOS result, historical promotion, observability metric, diagnostic, research-memory lesson, experiment priority, market-consensus provenance, microstructure snapshot, residual-momentum result, adaptive-accuracy result, meta-WAIT diagnostic, regime-strategy diagnostic, economic-calibration diagnostic, cross-sectional diagnostic, ensemble-diversity diagnostic, error-attribution diagnostic, selective-WAIT fusion result, shadow execution result, virtual-specialist result, or paper result by itself may authorize live BUY/SELL.
