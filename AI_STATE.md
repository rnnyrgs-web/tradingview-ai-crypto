...
Current tested functional integration baseline after PR #236: `1a1200cd30575469f7ac9525546f017a0a2c507d`. PR #236 exact head `332f868d48b9a489ad42f25937a3c25c945585a0` passed Security and Reliability #1700 before squash merge. PR #235 immediately before it introduced the separate V2 OI close-to-period-end challenger as code/configuration; #236 completed the missing runtime diagnostic wiring without adding V2 persistence or authority.
...
Immediately before #236, both Render services were live on #235 commit `28b8200e4189667e5d1aef6037e647b768791e16`. The sampled coordinator window remained healthy: worker failures=0, worker timeouts=0, supervisor healthy, no stale/crashed workers and no task restarts. ACC-002 remained naturally blocked by pure `InsufficientHistory`; untouched OOS stayed closed. Deployment of #236 began automatically after its merge and must be verified live before treating V2 runtime diagnostics as operational evidence.
...
#235/#236 and older FFriZz PRs #214/#216/#217/#219/#221/#223/#225/#227/#229/#231 are integrated and must not be re-applied. #230/#232/#233/#234 are state-only/reconciliation work. Stale PRs #34, #33 and #13 remain incompatible with current main and must not be merged as-is without fresh relevance/compatibility review.
...
3. Observe the first natural post-#236 `FFRIZZ_SECONDARY_V2_OI_CLOSE_END` count-only runtime diagnostic for 6h/12h/24h. Verify `price_oi_correlation_v2` availability by horizon, that diagnostics remain bounded/symbol-free, and that V2 uses no interpolation/backfill or authority. If OI remains unavailable, diagnose exact endpoint/cadence/data-source provenance rather than loosening matching.
4. Keep V2 separate from V1. Do not persist V2 forecasts or compare precision/expectancy until the V2 fingerprint's timestamp semantics and feature availability are prospectively verified and a separately reviewed forward-ledger design passes canonical safety requirements.
