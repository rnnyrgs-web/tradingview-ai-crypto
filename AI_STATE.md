...
## EXACT NEXT STEP
1. Verify the first authenticated post-deploy production scan completes with two-source consensus where available, fails closed where not, passes `tools/validate_scan_response.py`, and contains no unvalidated trade.
