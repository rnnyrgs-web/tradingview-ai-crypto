...
Last reconciled: 2026-09-20T17:44Z
Last updated: 2026-09-20T17:44Z
...
**PR #487 = INTEGRATED RUNTIME-RESTORE REPAIR, STILL SUBJECT TO THE MATCHED-CONTROL BLOCKER.** The Lead merged exact head `73d23822ebed6e1d376189ad6e4b1414636f1951` to main `dbf45d2f7e0117bcc506937c9d047a461dbee049`. It restores historical underdeclared families without granting fresh sibling/support authority and prospectively derives 14-32 synthetic pairs from the durable project slot. Focused verification passed 67 tests and Security & Reliability run `35501600018` succeeded. The merge occurred before the matched-control correction: its dynamic acceptance fixture freezes economic units but not the exact ordered outcome/control observation identities. Therefore exact-deployed acceptance remains blocked pending the corrective pair contract and genuinely matured units.

**PR #486 = INTEGRATED BOUNDED PAIR-ID REPAIR WITH RESIDUAL SELECTION RISK.** Exact head `7b292102f9faece53eea101fdd2a487ae4583185` passed Security & Reliability run `35502003520` and merged as `361d110113700649dadf5d606456e8355945c17e`. It froze ordered outcome/control IDs, but independent review then reproduced same-ID post-outcome selection using changed source/metric/provenance. The repair was necessary, not sufficient for confirmatory matched-control integrity.

**PR #490 = INTEGRATED SELECTOR REPAIR, RESIDUAL CONTROL-SELECTION RISK OPEN.** Exact head `c51a6e44dfff87656099c9e803ec5764a6b697cc` passed Security & Reliability run `35503814702`, merged as `580989412f96fb770992808a13900cd48d1f0328`, and postmerge run `35503942238` passed. It freezes source, metric and provenance URI and fails closed on malformed durable selector input. Independent review still reproduced venue/revision or same-ID value selection after outcomes. Do not treat the metadata selector as a deterministic control-selection guarantee.

**PR #488 = INTEGRATED PROSPECTIVE SUBJECT-ISOLATION REPAIR.** Exact head `c27213b0eff36df9b549d60d12793603bb7c164b` passed Security & Reliability run `35504106158` and independent review, then merged as `d200f84db125b6ee716c605a6f59044d6fc2dcfd`. Postmerge Security & Reliability run `35504312612` passed. The exact-deployed causal runtime run `35504312609` returned `WAIT_PROSPECTIVE_SYNTHETIC_EVALUATION`, not acceptance. Read-only durable metadata showed a plan frozen at 2026-09-20T10:10:57Z with 14 planned non-overlapping units, 14 exact pairs, 14 selectors and no new support event; untouched OOS/forward data were not opened. Its first nominal eligible check is 2026-09-21T05:08Z. A scientific-code change starts a new plan and a new genuine maturity guard.

**PR #489 = MERGED WITH A STILL-OPEN IMPORTANT CONTROL-SELECTION DEFECT.** Exact head `0192af0e549dbc17545c96dd2fdab24352c70371` passed Security & Reliability run `35504464441` and merged as `f417bcd72fd3689dc4378166eda1ecd012fa1161`. Independent review after merge reproduced six frozen pairs with unchanged IDs, metric, source, provenance URI and caller-asserted selection-contract ID that accepted post-outcome venue/revision selection as confirmatory (recomputed p=0.015625); durable replay preserved `confirmatory=True`. The same attack reproduced on exact current main `3f26eb3166f4953bfd07e3fd4d31b96a381c6d40` and is recorded in PR #489 review `5261245244` and current-main follow-up `5751483602`. Do not call the merged contract deterministic or Phase-3 complete. A new correction must freeze relevant provenance and verify control selection against an independent trusted source or deterministic evaluator; unknown/unverifiable selectors fail closed.

**PR #493 = MERGED LEGACY SELECTOR REPLAY REPAIR.** Exact head `9fbbd1dadd46cac99e80cff3a964d523d6344b40` passed Security & Reliability run `35507101287` and merged as `105bc4aa6e7c0463c1e469bdf018b47fb36164e5`. It restores authentic pre-#489 selector-only durable documents for audit while withholding confirmatory authority; independent replay probe passed on current main. This closes the historical #489 restore/HTTP-500 failure, not the post-outcome control-selection defect.

**PR #480 AND #494 = MERGED SEPARATE PHASE-3 IDENTITY REPAIRS.** PR #480 exact head `a10e277f052b4df5f080a5dfcba885ebf53932c8` passed Security & Reliability run `35511717554` and merged as `69806f20d6d1a16b606c6b0da0dd60c256d7bc2b`, addressing the known-fingerprint strategy/science-design omission path. PR #494 exact head `bda7a6eaec3e594ee03957a5fc0d1b23e6e6658c` passed run `35523323464` and merged as current verified main `3f26eb3166f4953bfd07e3fd4d31b96a381c6d40`, binding transitive executor source and runtime resources. Exact merged-main Security & Reliability run `35525133770` succeeded. These bounded identity repairs do not close the causal control-selection attack or establish profitability.

**PR #491 = OPEN PROSPECTIVE-PLAN CONTINUITY CORRECTION.** Its observed 2026-09-20T17:47Z exact head `fb633dd4b1f16df47c43fa4c03206df09798f79d` is rebased on `3f26eb3166f4953bfd07e3fd4d31b96a381c6d40`; Focused tests and exact-head Security & Reliability run `35526894076` pass on that head; the earlier `38d0731eac2246607e947a7f6c8b4830d5270a4e` also passed 102 focused tests and run `35526620237`. It binds synthetic plan identity to packaged science, sealed input, Dockerfile, trusted-executor manifest and resolved Python/container dependencies while retaining exact deployed-SHA reporting. Fresh independent exact-head review remains required. Hold integration until the current-main trusted control-selection defect is corrected, then rebase/reverify #491 so the prospective fixture uses the final contract. The earlier 14-unit plan's nominal 2026-09-21T05:08Z check cannot be treated as valid for a changed scientific fingerprint.
...
**Remaining blocking Phase-3 findings:** repair the confirmed current-main post-outcome causal control-selection bypass with RED regression, independent trusted verification and fail-closed durable replay; then rebase/review/integrate PR #491's prospective-plan continuity and require new genuine maturity plus exact-deployed acceptance success. Independently continue falsifying merged profitability semantic/executor identity, attribution/ablation, successor duplication, adaptive stopping/repeated looks, chronology, stale/rejected memory and restart/replay/race/outage/corruption. Keep issue #462 and `COORD-ARCH-ADVERSARIAL-001` open. Do not start V2-002 or Phase 4.
...
Continue `COORD-ARCH-ADVERSARIAL-001` under issue #462. Correct the independently reproduced venue/revision/value control-selection attack on exact main `3f26eb3166f4953bfd07e3fd4d31b96a381c6d40` in an isolated branch: REPRODUCE -> REGRESSION -> FIX -> exact-head CI -> independent review -> separate Lead integration -> exact postmerge verification. Freeze relevant provenance and require independent trusted control-selection verification; a caller-asserted contract label alone is insufficient. Unknown/unverifiable source records remain WAIT / RESEARCH_ONLY. Then rebase PR #491 onto the correction, repeat its gates, integrate through protected main and verify exact-deployed synthetic runtime. Wait for its actual durable `next_check_at`; trigger an additional check after maturity if the scheduled 04:17 UTC run is early. Keep protected OOS/forward closed and broker/trade/promotion authority disabled. Update this canonical state with each verified integration. Do not start V2-002 or Phase 4.