...
</style></head><body><div class="wrap"><header><div><h1>Current Account Value: {_money(equity)}</h1><span class="badge {badge_cls}">{badge}</span></div><div><a href="/dashboard">Signals</a></div></header>
<div class="cards">
