...
def test_natural_language_risk_premium_does_not_look_like_openai_key(tmp_path: Path):
    lines = [
        ...
        (
            ...
            'sk-hynix-holds-groundbreaking-ceremony-4-billion-indiana-ai-chip-packaging-2026-08-27/"'
        ),
