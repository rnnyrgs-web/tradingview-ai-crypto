...
def _rows(n=120, *, horizon="24h", with_consensus=True):
...
def test_a_plus_profile_requires_strong_dev_validation_and_cost_stress():
    ...
    assert candidate["development_precision_lift_vs_actionable"] >= 0.02
    assert candidate["validation_precision_lift_vs_actionable"] >= 0.02
