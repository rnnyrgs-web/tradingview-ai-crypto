"""Bounded local research-memory state for continuous learning.

This is deliberately advisory-only. It stores compact lessons about research
outcomes so workers can avoid blindly repeating low-information experiments.
Production strategies, thresholds, broker behavior and trade authority are not
